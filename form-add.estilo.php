...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <p class="h3 text-center">Cadastro de estilo</p>
        </div>
        <form action="addTarefa.php" method="post">
            <div class="form-group">
                <label for="descricao">Descrição: </label>
                <input type="text" class="form-control" name="descricao" id="descricao" required minlength="5" placeholder="Informe o estilo da banda">
            </div>
            <div class="form-group">
                <label for="selectTipo">Selecione o estilo desejado</label>
